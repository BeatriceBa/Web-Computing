...
<script type="text/javascript" src="./js/modifyInfo.js">
				...
				<div class="columns is-centered">
					...
					<div class="column">
						<form action="ModifyInfo?isbn=${bd.getISBN()}" class="box"
								...
								<div class="field">
									...
									<div class="control has-icons-left">
										<input type="text" name="title" value="${bd.getTitle()}"
											...
											class="icon is-small is-left"> <i class="fas fa-book"></i>
										</span>
									</div>
								</div>
							</h1>
							...
							<div class="field">
								...
								<div class="control has-icons-left">
									<textarea id="story" name="description" rows="5" cols="33"
										class="input" required> ${bd.getDescription()} </textarea>
							...
							<br> <b>ISBN: </b>${bd.getISBN()}<br> <b>Data di
								Pubblicazione: </b> ${bd.getYear()} <br> <br>
							<div class="field">
